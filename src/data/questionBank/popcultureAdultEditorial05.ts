...
const FACTS: Fact[] = [
  ...
  ['Dans quel jeu d’infiltration contrôle-t-on l’agent surnommé Snake ?', 'Metal Gear Solid', 'Splinter Cell', 'Syphon Filter', 'Hitman', 'Solid Snake infiltre Shadow Moses dans Metal Gear Solid, sorti sur PlayStation en 1998.'],
  ...
  ['Quel jeu de plateau place des clans écossais sur une île des Hébrides ?', 'Isle of Skye', 'Clans of Caledonia', 'Glen More', 'A Feast for Odin', 'Isle of Skye combine pose de tuiles et fixation secrète du prix des paysages.'],
  ['Quel jeu de société d’Étienne Espreman se déroule dans la capitale belge à l’époque de l’Art nouveau ?', 'Bruxelles 1893', 'Troyes', 'Ginkgopolis', 'Black Angel', 'Bruxelles 1893 mêle enchères, majorité et placement d’ouvriers autour de l’architecture.'],
