...
const FACTS: Fact[] = [
  ...
  ['Quelle série suit les habitantes d’un quartier de Wisteria Lane ?', 'Desperate Housewives', 'Big Little Lies', 'Devious Maids', 'Why Women Kill', 'La série créée par Marc Cherry débute par le suicide de Mary Alice Young.'],
  ...
  ['Quelle série sud-coréenne met en scène un concours mortel pour personnes endettées ?', 'Squid Game', 'Alice in Borderland', 'Sweet Home', 'Hellbound', 'Squid Game oppose 456 candidats dans des versions meurtrières de jeux d’enfants.'],
  ...
  ['Quelle série canadienne suit la famille Rose contrainte de vivre dans une petite ville ?', 'Schitt’s Creek', 'Kim’s Convenience', 'Letterkenny', 'Workin’ Moms', 'Eugene et Dan Levy ont créé Schitt’s Creek et y jouent Johnny et David Rose.'],
  ...
  ['Quel jeu de rôle place le joueur dans le village de Tristram face à Diablo ?', 'Diablo', 'Baldur’s Gate', 'Torchlight', 'Dungeon Siege', 'Le premier Diablo fait descendre le héros sous la cathédrale de Tristram.'],
