...
const FACTS: Fact[] = [
  ...
  ['Sur quel support les codex mayas étaient-ils peints avant la conquête espagnole ?', 'De l’écorce de figuier enduite de chaux', 'Du parchemin de chèvre', 'Du papyrus importé', 'De la soie tissée', 'Quatre codex mayas seulement ont échappé aux autodafés du XVIe siècle.'],
  ...
  ['Que racontent les grands mâts sculptés dressés par les peuples haïdas et tlingits ?', 'Des lignages et des droits familiaux', 'Des prières funéraires', 'Des traités de paix signés', 'Des calendriers agricoles', 'Ce ne sont pas des objets de culte : on les appelle mâts héraldiques plutôt que totems.'],
  ['Quelle pierre tendre les sculpteurs inuits du Grand Nord travaillent-ils le plus souvent ?', 'La stéatite', 'Le marbre', 'Le granite', 'L’albâtre', 'Aussi appelée pierre à savon, elle se taille au couteau et se polit à la main.'],
  ['Quel art textile amérindien du Sud-Ouest est célèbre pour ses couvertures et tapis géométriques ?', 'Le tissage navajo', 'Le patchwork seminole', 'Le finger weaving cree', 'Le tissage chilkat', 'Les tisserandes navajos développèrent des styles régionaux après l’introduction du mouton par les Espagnols.'],
