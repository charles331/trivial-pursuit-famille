...
const FACTS: HistoryFact[] = [
  ...
  ['Quel royaume africain avait Grand Zimbabwe pour centre monumental ?', 'Le royaume du Zimbabwe', 'Le royaume du Kongo', 'Le royaume du Bénin', 'Le royaume du Monomotapa', 'Grand Zimbabwe prospéra surtout entre les XIe et XVe siècles grâce au commerce régional et lointain.'],
