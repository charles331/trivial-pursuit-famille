...
const FACTS: HistoryFact[] = [
  ...
  ['Quel pays d’Afrique australe doit son nom aux ruines d’une cité de pierre sèche médiévale ?', 'Le Zimbabwe', 'Le Mozambique', 'La Zambie', 'Le Botswana', 'Ses murailles sont montées sans mortier ; le site a donné son nom au pays lors de l’indépendance en 1980.'],
  ...
  ['Quel mouvement coréen réclama l’indépendance face au Japon au printemps 1919 ?', 'Le Mouvement du 1er Mars', 'Le Mouvement du 4 Mai', 'Le Tonghak', 'Le Saemaul Undong', 'Les manifestations pacifiques furent réprimées mais renforcèrent le nationalisme coréen.'],
  ...
  ['Quel conflit de juin 1967 opposa Israël à trois de ses voisins arabes ?', 'La guerre des Six Jours', 'La guerre du Kippour', 'La guerre d’Attrition', 'La guerre du Liban', 'Israël affronta l’Égypte, la Jordanie et la Syrie et occupa plusieurs territoires à l’issue du conflit.'],
