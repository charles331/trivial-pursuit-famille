...
const FACTS: Fact[] = [
  ...
  ['Qui conçut la police de caractères sans empattement du métro de Londres ?', 'Edward Johnston', 'Eric Gill', 'Harry Beck', 'Herbert Bayer', 'La police sans empattement de Johnston fut commandée en 1913 par Frank Pick.'],
