...
const FACTS: Fact[] = [
  ...
  ['Quel film philippin de Lino Brocka suit Julio dans les bas-fonds de Manille ?', 'Manille', 'Insiang', 'Jaguar', 'Bayan Ko', 'Manille dans les griffes de la lumière décrit exploitation et violence urbaine sous Marcos.'],
  ...
  ['Quel documentaire de Claude Lanzmann dure plus de neuf heures et traite de la Shoah ?', 'Shoah', 'Nuit et Brouillard', 'Le Chagrin et la Pitié', 'Hôtel Terminus', 'Lanzmann construisit Shoah sans images d’archives, à partir de témoignages et de lieux filmés.'],
