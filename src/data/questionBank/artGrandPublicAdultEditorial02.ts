...
const FACTS: Fact[] = [
  ...
  ['Quelle célèbre formule de l’architecte germano-américain Mies van der Rohe résume son approche minimaliste ?', '« Less is more »', '« Form follows function »', '« Ornament is crime »', '« Small is beautiful »', 'Cette formule, « moins, c’est plus », est devenue un grand principe de l’architecture minimaliste du XXe siècle.'],
