...
const FACTS: Fact[] = [
  ...
  ['Quel médecin recommanda le lavage des mains dans les maternités de Vienne ?', 'Ignace Semmelweis', 'Joseph Lister', 'John Snow', 'Rudolf Virchow', 'Semmelweis réduisit fortement la fièvre puerpérale en imposant une désinfection chlorée des mains.'],
  ...
  ['Quelle épidémie fut identifiée pour la première fois en 1976 près de la rivière Ebola ?', 'La maladie à virus Ebola', 'La fièvre de Lassa', 'La maladie de Marburg', 'La fièvre jaune', 'Deux flambées presque simultanées eurent lieu au Soudan et au Zaïre en 1976.'],
  ...
  ['Quel conflit permit l’indépendance de l’Algérie en 1962 ?', 'La guerre d’Algérie', 'La guerre du Rif', 'La crise de Bizerte', 'La guerre des Sables', 'Les accords d’Évian mirent fin aux combats et furent suivis d’un référendum d’autodétermination.'],
  ...
  ['Quelle guerre aboutit à l’indépendance du Bangladesh en 1971 ?', 'La guerre de libération du Bangladesh', 'La première guerre du Cachemire', 'La guerre sino-indienne', 'La guerre civile sri-lankaise', 'L’intervention de l’Inde accompagna la défaite des forces pakistanaises au Pakistan oriental.'],
  ...
  ['Quel dirigeant tunisien proclama la république en 1957 ?', 'Habib Bourguiba', 'Salah Ben Youssef', 'Moncef Bey', 'Farhat Hached', 'L’Assemblée constituante abolit la monarchie husseinite et élut Bourguiba président.'],
