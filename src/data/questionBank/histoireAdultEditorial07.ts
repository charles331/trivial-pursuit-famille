...
const FACTS: Fact[] = [
  ...
  ['Quelle organisation mondiale mena la campagne ayant éradiqué la variole ?', 'L’Organisation mondiale de la santé', 'L’UNICEF', 'La Croix-Rouge', 'La Société des Nations', 'La variole reste à ce jour la seule maladie humaine officiellement éradiquée dans le monde.'],
