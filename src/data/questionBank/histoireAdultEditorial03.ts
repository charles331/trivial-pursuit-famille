...
const FACTS: HistoryFact[] = [
  ...
  ['Quelle alliance de provinces révoltées fut conclue à Utrecht en 1579 ?', 'L’Union d’Utrecht', 'L’Union d’Arras', 'La Ligue de Cambrai', 'La Pacification de Gand', 'L’Union d’Utrecht fédéra les provinces du nord des Pays-Bas contre Philippe II.'],
  ...
  ['Quel traité de 1715 fixa le régime de la Barrière dans les Pays-Bas autrichiens ?', 'Le traité de la Barrière', 'Le traité d’Aix-la-Chapelle', 'Le traité de Rastatt', 'Le traité de Fontainebleau', 'Le traité permit aux Provinces-Unies de tenir des garnisons dans plusieurs forteresses des Pays-Bas autrichiens.'],
  ...
  ['Quelle université francophone quitta Louvain après la crise de 1968 ?', 'L’Université catholique de Louvain', 'L’Université libre de Bruxelles', 'L’Université de Liège', 'L’Université de Mons', 'L’UCL s’installa progressivement à Louvain-la-Neuve, ville créée en Brabant wallon.'],
  ...
  ['Quelle guerre opposa le Nigeria à la région sécessionniste du Biafra ?', 'La guerre du Biafra', 'La guerre de l’Ogaden', 'La guerre du Shaba', 'La guerre du Kivu', 'Le conflit de 1967 à 1970 provoqua une famine qui suscita une vaste mobilisation humanitaire.'],
