...
const FACTS: Fact[] = [
  ...
  ['Quel concile de 325 formula une première version du credo chrétien ?', 'Le premier concile de Nicée', 'Le concile de Chalcédoine', 'Le concile d’Éphèse', 'Le concile de Constantinople', 'Convoqué par Constantin, Nicée condamna notamment l’enseignement d’Arius sur la nature du Christ.'],
  ...
  ['Quel entrepreneur britannique mit au point un convertisseur pour produire l’acier en masse ?', 'Henry Bessemer', 'Andrew Carnegie', 'Abraham Darby', 'Robert Mushet', 'Le convertisseur Bessemer permit une production rapide et moins coûteuse d’acier au XIXe siècle.'],
