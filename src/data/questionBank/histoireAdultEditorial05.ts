...
const FACTS: Fact[] = [
  ...
  ['Quel Français a percé le secret des hiéroglyphes égyptiens en 1822 ?', 'Jean-François Champollion', 'Louis Pasteur', 'Gustave Eiffel', 'Jules Verne', 'Il s’appuya sur la pierre de Rosette, qui portait le même texte en grec et en égyptien.'],
