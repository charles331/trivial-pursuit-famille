...
const FACTS: Fact[] = [
  ...
  ['Quel album de Tintin fut publié en deux tomes autour d’un voyage vers notre satellite naturel ?', 'Objectif Lune et On a marché sur la Lune', 'Le Temple du Soleil', 'Vol 714 pour Sydney', 'Coke en stock', 'Hergé s’est appuyé sur les travaux de l’ingénieur Bernard Heuvelmans, quinze ans avant Apollo 11.'],
