...
const FACTS: Fact[] = [
  ...
  ['Quel fromage français à pâte pressée cuite est fabriqué en Franche-Comté sous AOP ?', 'Le comté', 'Le cantal', 'Le beaufort', 'Le reblochon', 'Il faut environ cinq cents litres de lait pour une seule meule de quarante kilos.'],
