...
const FACTS: Fact[] = [
  ...
  ['Quel club belge joue au stade Constant Vanden Stock à Bruxelles ?', 'Le RSC Anderlecht', 'Le Club Bruges', 'L’Union Saint-Gilloise', 'Le Sporting Charleroi', 'Surnommé les Mauves, c’est le club le plus titré du championnat de Belgique.'],
  ...
  ['Quelle course automobile d’endurance belge se dispute chaque été sur le tracé de Francorchamps ?', 'Les 24 Heures de Spa', 'Les 6 Heures de Francorchamps', 'Le Grand Prix des Ardennes', 'Le Rallye de Wallonie', 'Elle se court depuis 1924, souvent sous la pluie caractéristique de la région.'],
