...
const SCIENCE: Fact[] = [
  ...
  ['Quel pourcentage de carbone distingue au maximum un acier d’une fonte ?', 'Environ 2 %', 'Environ 10 %', 'Environ 20 %', 'Environ 40 %', 'Au-delà, l’alliage de fer devient une fonte, plus dure mais cassante.'],
  ...
  ['Quelle unité utilise-t-on couramment en météorologie pour les pressions ?', 'L’hectopascal', 'Le kilowatt', 'Le siemens', 'Le becquerel', 'Une pression de 1 013 hectopascals correspond à la moyenne au niveau de la mer ; sous 1 000, une dépression s’installe.'],
