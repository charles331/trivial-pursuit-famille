...
const FACTS: Fact[] = [
  ['Quelle souveraine égyptienne fit édifier un temple funéraire à Deir el-Bahari ?', 'Hatchepsout', 'Néfertiti', 'Cléopâtre VII', 'Tiyi', 'Hatchepsout régna comme pharaon au XVe siècle av. J.-C. et développa notamment les échanges avec le pays de Pount.'],
  ['Quelle reine de Palmyre défia Rome au IIIe siècle ?', 'Zénobie', 'Bérénice', 'Arsinoé', 'Tomyris', 'Zénobie étendit brièvement son contrôle sur l’Égypte et l’Asie Mineure avant d’être vaincue par Aurélien.'],
  ['Quelle impératrice chinoise fonda sa propre dynastie Zhou en 690 ?', 'Wu Zetian', 'Cixi', 'Lü Zhi', 'Wei', 'Wu Zetian est la seule femme à avoir porté officiellement le titre d’empereur dans l’histoire chinoise.'],
  ['Quelle souveraine géorgienne régna pendant l’âge d’or du royaume au XIIe siècle ?', 'Tamar', 'Rousoudan', 'Ketevan', 'Nino', 'Le règne de Tamar vit l’expansion politique et culturelle de la Géorgie médiévale.'],
  ...
  ['Quelle dirigeante angolaise résista aux Portugais au XVIIe siècle ?', 'Njinga', 'Amina de Zaria', 'Yaa Asantewaa', 'Nandi', 'Njinga gouverna les royaumes de Ndongo et Matamba et mena une diplomatie complexe face au Portugal.'],
  ...
  ['Quelle militante britannique fonda la Women’s Social and Political Union ?', 'Emmeline Pankhurst', 'Sylvia Pankhurst', 'Millicent Fawcett', 'Emily Davison', 'Emmeline Pankhurst fonda la WSPU en 1903 avec plusieurs autres militantes, dont sa fille Christabel.'],
  ...
  ['Quelle insurrection de canuts éclata à Lyon en 1831 ?', 'La première révolte des canuts', 'La Commune de Lyon', 'La révolte des vignerons', 'La grève de Carmaux', 'Les ouvriers de la soie se soulevèrent autour du mot d’ordre « Vivre en travaillant ou mourir en combattant ».'],
  ...
  ['Quelle marche ouvrière de 1936 relia Jarrow à Londres ?', 'La Jarrow Crusade', 'La Marche de la faim de Cork', 'La Marche de Tolpuddle', 'La Marche de Glasgow', 'Des chômeurs de Jarrow marchèrent pour alerter le gouvernement sur la désindustrialisation de leur ville.'],
  ...
  ['Quel astronome danois fit construire l’observatoire d’Uraniborg ?', 'Tycho Brahe', 'Johannes Kepler', 'Ole Rømer', 'Christiaan Huygens', 'Tycho Brahe réalisa à Uraniborg des observations très précises avant l’usage du télescope.'],
  ...
  ['Quelle astronome systématisa la classification spectrale O, B, A, F, G, K, M ?', 'Annie Jump Cannon', 'Henrietta Leavitt', 'Cecilia Payne', 'Maria Mitchell', 'Cannon classa des centaines de milliers d’étoiles selon cette séquence encore utilisée.'],
  ...
  ['Quelle conférence de 1961 donna naissance au Mouvement des non-alignés ?', 'La conférence de Belgrade', 'La conférence de Bandung', 'La conférence du Caire', 'La conférence d’Accra', 'Des dirigeants comme Tito, Nasser, Nehru, Nkrumah et Soekarno participèrent au sommet de Belgrade.'],
