...
const REPLACEMENTS: Replacement[] = [
  ...
  ['his_adulte_editorial_06_017', 'En Belgique, quel slogan symbolisa la crise linguistique de l’université de Louvain en 1968 ?', 'Leuven Vlaams', 'Walen buiten Brussel', 'België barst', 'Vive le roi', 'Le slogan réclamait une université néerlandophone à Louvain et entraîna la scission de l’institution.'],
