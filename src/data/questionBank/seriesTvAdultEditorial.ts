...
const FACTS: Fact[] = [
  ...
  ["Quelle série suit l'avocate Diane Lockhart après la perte de ses économies dans une fraude ?", "The Good Fight", "Suits", "How to Get Away with Murder", "Damages", "The Good Fight reprend plusieurs personnages de The Good Wife et débute sur une fraude financière."],
  ...
  ["Quelle série de David Chase suit un parrain du New Jersey en thérapie ?", "Les Soprano", "Ray Donovan", "Boardwalk Empire", "Oz", "Tony consulte une psychiatre tout en dirigeant une organisation criminelle du New Jersey."],
  ...
  ["Quelle série allemande suit l'inspecteur Gereon Rath sous la république de Weimar ?", "Babylon Berlin", "Dark", "Deutschland 83", "Charité", "L'enquête policière croise conflits politiques, cabarets et crise sociale à la fin des années 1920."],
