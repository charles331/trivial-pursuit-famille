...
const FACTS: Fact[] = [
  ...
  ['Quel empereur byzantin fit compiler le Digeste et les Institutes ?', 'Justinien Ier', 'Théodose Ier', 'Léon III', 'Constantin VII', 'Le Corpus juris civilis de Justinien fut élaboré au VIe siècle sous la direction de Tribonien.'],
  ...
  ['Quelle académie fondée par Platon enseignait près d’Athènes ?', 'L’Académie', 'Le Lycée', 'Le Portique', 'Le Jardin', 'Platon fonda son école au IVe siècle av. J.-C. dans un sanctuaire consacré au héros Académos.'],
  ...
  ['Quelle agence de presse française fut fondée par Charles-Louis Havas ?', 'L’agence Havas', 'Reuters', 'Associated Press', 'Wolffs Telegraphisches Bureau', 'Fondée en 1835, Havas est un ancêtre de l’Agence France-Presse.'],
  ['Quel inventeur transmit la voix par radio depuis Brant Rock en 1906 ?', 'Reginald Fessenden', 'Guglielmo Marconi', 'Lee de Forest', 'Edwin Armstrong', 'Fessenden réalisa l’une des premières émissions radiophoniques de voix et de musique.'],
