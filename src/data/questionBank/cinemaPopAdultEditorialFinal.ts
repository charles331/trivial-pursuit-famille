...
const CINEMA_FACTS: Fact[] = [
  ...
  ['Quel film néoréaliste du réalisateur italien Vittorio De Sica suit un retraité romain et son chien Flike ?', 'Umberto D.', 'Sciuscià', 'Miracle à Milan', 'Le Jardin des Finzi-Contini', 'Umberto D. dépeint la précarité d’un retraité dans l’Italie d’après-guerre.'],
  ...
  ['Dans quel film un roi britannique travaille-t-il son bégaiement avant de parler à la radio ?', 'Le Discours d’un roi', 'Les Heures sombres', 'The Queen', 'Elizabeth', 'Le thérapeute Lionel Logue aide le futur George VI à préparer ses prises de parole publiques.'],
  ...
  ['Quel documentaire de la réalisatrice néo-zélandaise Merata Mita filme une occupation māorie près d’Auckland ?', 'Bastion Point: Day 507', 'Mauri', 'Utu', 'Once Were Warriors', 'Merata Mita documenta l’expulsion policière qui mit fin à 506 jours d’occupation.'],
  ...
  ['Quel film allemand suit un fils cachant la réunification du pays à sa mère sortie du coma ?', 'Good Bye, Lenin!', 'La Vie des autres', 'Barbara', 'La Chute', 'Alex recrée dans leur appartement le quotidien de l’Allemagne de l’Est afin d’éviter un choc à sa mère fragile.'],
];
