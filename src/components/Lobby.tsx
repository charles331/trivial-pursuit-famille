              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                    {BOARD_PRESETS[gameState.settings.boardType].name} · {gameState.settings.timerSeconds === 0 ? 'sans chrono' : `${gameState.settings.timerSeconds}s`} · {gameState.settings.wedgesToWin} camemberts{gameState.settings.enableBonuses ? ' · bonus activés' : ''}
                  </p>
                </div>
