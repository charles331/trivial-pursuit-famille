      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 shadow-xl border border-slate-200 dark:border-slate-800 space-y-5">
        ...
        {tab === 'join' && (
          <form onSubmit={handleJoinSubmit} className="space-y-3 pt-2">
            {codeFromUrl && (
              <div className="p-3 bg-amber-500/15 border border-amber-500/40 text-amber-900 dark:text-amber-300 text-xs font-bold rounded-2xl flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-amber-500 shrink-0 animate-pulse" />
                <span>Lien de salon détecté : <strong className="font-mono text-amber-600 dark:text-amber-400">{codeFromUrl.toUpperCase()}</strong>. Choisissez votre profil ci-dessus puis cliquez sur Rejoindre !</span>
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                maxLength={8}
                className="w-full px-4 py-3 rounded-2xl border-2 border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white font-mono font-black text-lg text-center tracking-widest focus:outline-none focus:border-amber-500"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-4 bg-amber-500 hover:bg-amber-400 text-slate-950 font-black text-sm rounded-2xl flex items-center justify-center gap-2 shadow-xl transition-all disabled:opacity-50"
            >
              Rejoindre le Salon
            </button>
          </form>
